...
namespace TX_Widget
{
    ...
    public class BWForm : FormBase
    {
        ...
        //private Image _formFringe = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.fringe_bkg.png");
        private Image _formFringe = Resource1.fringe_bkg;
        ...
        private void UpdateMaxButton()
        {
            ...
            if (isMax)
            {
                //SystemButtonManager.SystemButtonArray[1].NormalImg = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.SystemButtons.restore_normal.png");
                //SystemButtonManager.SystemButtonArray[1].HighLightImg = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.SystemButtons.restore_highlight.png");
                //SystemButtonManager.SystemButtonArray[1].DownImg = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.SystemButtons.restore_down.png");
                SystemButtonManager.SystemButtonArray[1].NormalImg = Resource1.restore_normal;
                SystemButtonManager.SystemButtonArray[1].HighLightImg = Resource1.restore_highlight;
                SystemButtonManager.SystemButtonArray[1].DownImg = Resource1.restore_down;
            ...
            {
                //SystemButtonManager.SystemButtonArray[1].NormalImg = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.SystemButtons.max_normal.png");
                //SystemButtonManager.SystemButtonArray[1].HighLightImg = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.SystemButtons.max_highlight.png");
                //SystemButtonManager.SystemButtonArray[1].DownImg = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.SystemButtons.max_down.png");
                //SystemButtonManager.SystemButtonArray[1].ToolTip = "最大化";

                SystemButtonManager.SystemButtonArray[1].NormalImg = Resource1.max_normal;
                SystemButtonManager.SystemButtonArray[1].HighLightImg = Resource1.max_highlight;
                SystemButtonManager.SystemButtonArray[1].DownImg = Resource1.max_down;
                SystemButtonManager.SystemButtonArray[1].ToolTip = "还原";
            }
        }
