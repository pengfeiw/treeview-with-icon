...
{
    /// <summary>
    /// 方向：tab水平，文字水平的tabcongtrol。
    /// tab可以停靠在上部和下部，但是不能停靠在左边和右边。
    /// </summary>
    [ToolboxBitmap(typeof(System.Windows.Forms.TabControl))] //,
    //Designer(typeof(Designers.FlatTabControlDesigner))]

    public class BWGreatHoriTabControl : System.Windows.Forms.TabControl
    {
        ...
        public BWGreatHoriTabControl()
        {
            ...
            System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(BWGreatHoriTabControl));
        ...
        internal void DrawControl(Graphics g)
        {
            ...
            Rectangle TabArea = this.DisplayRectangle;   //tabpage的显示大小。
            ...
            TabArea.Inflate(nDelta, nDelta);   //指定System.Rectangle放大。
        ...
        internal void DrawTab(Graphics g, TabPage tabPage, int nIndex)
        {
            ...
            g.DrawPolygon(SystemPens.ControlDark, pt);  //绘制tab边界。
        ...
        {
            bool bFound = false;  //判断是否找到数值调节按钮。

            // find the UpDown control
            IntPtr pWnd = Win32.GetWindow(this.Handle, Win32.GW_CHILD);  //获得当前窗口的子窗口。
            ...
            while (pWnd != IntPtr.Zero)
            {
                ...
                //"msctls_updown32"数值调节钮控件的类名，例如：日期控件中的下拉按钮
                ...
                pWnd = Win32.GetWindow(pWnd, Win32.GW_HWNDNEXT);   //找兄弟窗口。
            }
