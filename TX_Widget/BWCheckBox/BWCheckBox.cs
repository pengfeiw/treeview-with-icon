...
namespace TX_Widget
{
    public class BWCheckBox : CheckBox
    {
        #region Field

        private BWControlState _state = BWControlState.Normal;
        //private Image _checkImg = RenderHelper.GetImageFormResourceFilePath(@"..\TX_Res\check.png");
        private Image _checkImg = Resource1.check;
        ...
        [Description("获取BWCheckBox左边正方形的宽度")]
