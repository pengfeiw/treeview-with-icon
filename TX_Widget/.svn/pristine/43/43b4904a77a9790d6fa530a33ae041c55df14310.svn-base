...
namespace TX_Widget
{
    public class BWGlassButton : PictureBox, IButtonControl
    {
        #region  Fileds
        ...
        //private Image _glassHotImg = RenderHelper.GetImageFormResourceStream("TX_Widget.BWControls.BWGlassButton.Image.glassbtn_hot.png");
        //private Image _glassDownImg = RenderHelper.GetImageFormResourceStream("TX_Widget.BWControls.BWGlassButton.Image.glassbtn_down.png");
        private Image _glassHotImg = Resource1.glassbtn_hot;
        private Image _glassDownImg = Resource1.glassbtn_down;
