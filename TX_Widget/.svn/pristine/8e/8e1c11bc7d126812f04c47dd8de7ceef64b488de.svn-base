...
namespace TX_Widget
{
    public class BWMessageBox : BWForm
    {
        ...
        public BWMessageBox(string msgText, string caption, BWMessageBoxIcon msgBoxIcon, BWMessageBoxButtons msgBoxButtons)
        {
        ...
        public static DialogResult Show(
            ...
            string msgText,
            string caption,
            BWMessageBoxIcon msgBoxIcon,
            BWMessageBoxButtons msgBoxButtons)
        {
            using (BWMessageBox msgBox = new BWMessageBox(msgText, caption, msgBoxIcon, msgBoxButtons))
            {
                if (owner != null)
                {
        ...
        public static DialogResult Show()
        {
            ...
            string msgText = "请输入提示信息";
             string caption = "提示";
            BWMessageBoxIcon msgBoxIcon = BWMessageBoxIcon.Information;
            BWMessageBoxButtons msgBoxButtons = BWMessageBoxButtons.OK;
            return Show(owner, msgText, caption, msgBoxIcon, msgBoxButtons);
        }

        public static Image MsgBoxBackgroundImg { get; set; }
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "BWMessageBox";
            this.ShowInTaskbar = false;
            this.ResumeLayout(false);

        }

        private void LoadMsgBoxIcon(BWMessageBoxIcon msgBoxIcon)
        {
            switch (msgBoxIcon)
            {
                case BWMessageBoxIcon.Error:
                    _msgBoxIcon = Resource1.messagebox_error;
                    break;
                case BWMessageBoxIcon.Information:
                    _msgBoxIcon = Resource1.messagebox_infor;
                    break;
                case BWMessageBoxIcon.OK:
                    _msgBoxIcon = Resource1.messagebox_ok;
                    break;
                case BWMessageBoxIcon.Question:
                    _msgBoxIcon = Resource1.messagebox_question;
                    break;
                case BWMessageBoxIcon.Warning:
                    _msgBoxIcon = Resource1.messagebox_warning;
                    break;
                default:
                    break;
            }
        ...
        private void LoadMsgBoxButtons(BWMessageBoxButtons msgBoxButtons)
        {
            switch (msgBoxButtons)
            {
                case BWMessageBoxButtons.OK:
                    CreateOKButton();
                    break;
                case BWMessageBoxButtons.OKCancel:
                    CreateOKCancelButton();
                    break;
                case BWMessageBoxButtons.RetryCancel:
        ...
        { //确定 取消
            BWButton okBtn = new BWButton();
            BWButton cancelBtn = new BWButton();
            this.SuspendLayout();
            // 
            // OKBtn
            // 
        ...
        {//重试 取消
            BWButton retryBtn = new BWButton();
            BWButton cancelBtn = new BWButton();
            this.SuspendLayout();
            // 
            // retryBtn
