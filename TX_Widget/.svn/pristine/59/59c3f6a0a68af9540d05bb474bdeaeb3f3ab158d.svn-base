...
namespace TX_Widget
{
    ...
    internal class SystemButtonManager : IDisposable
    {
        ...
        private void IniSystemButtons()
        {
            ...
            closeBtn.ToolTip = "关闭";
            //closeBtn.NormalImg = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.SystemButtons.close_normal.png");
            //closeBtn.HighLightImg = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.SystemButtons.close_highlight.png");
            //closeBtn.DownImg = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.SystemButtons.close_down.png");
            closeBtn.NormalImg = Resource1.close_normal;
            closeBtn.HighLightImg = Resource1.close_highlight;
            closeBtn.DownImg = Resource1.close_down;
            ...
            if (isShowMaxButton)
            {
                //MaxBtn.NormalImg = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.SystemButtons.max_normal.png");
                //MaxBtn.HighLightImg = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.SystemButtons.max_highlight.png");
                //MaxBtn.DownImg = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.SystemButtons.max_down.png");

                MaxBtn.NormalImg = Resource1.max_normal;
                MaxBtn.HighLightImg = Resource1.max_highlight;
                MaxBtn.DownImg = Resource1.max_down;
            ...
            //minBtn.NormalImg = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.SystemButtons.min_normal.png");
            //minBtn.HighLightImg = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.SystemButtons.min_highlight.png");
            //minBtn.DownImg = RenderHelper.GetImageFormResourceStream("TX_Widget.FormEx.Res.SystemButtons.min_down.png");

            minBtn.NormalImg = Resource1.min_normal;
            minBtn.HighLightImg = Resource1.min_highlight;
            minBtn.DownImg = Resource1.min_down;
